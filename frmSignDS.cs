...
namespace SugarSystem.Client
{
    ...
    public partial class frmSignDS : Form
    {
        ...
        private void btnSign_Click(object sender, EventArgs e)
        {
            try
            {
                #region OldCode in region
                //Old code form XFA 

                //if (message2(txtXML.Text, From, lblRefNo.Text, SIG_IMAGE, SignSNToken))
                //{
                //    //udate status
                //    //MessageBox.Show("ลงนามเรียบร้อย");
                //    MessageBox.Show("ลงนามเรียบร้อย\n" + MsgStatus);
        ...
        #region ฟังก์ชั่น รับค่า XML จากหน้าเว็บ(ตัวเก่า)
        //public Boolean message2(string strxml, string FormType, string Reference, string SignaturePath, string SignSNToken)
        //{
        ...
        //        xdoc.LoadXml(xmlfromweb);
        //        byte[] bxml = System.Text.Encoding.UTF8.GetBytes(xdoc.OuterXml);
        ...
        //        //CertificateGenerationConnector.CertificateGenerationClientConnector connector = new CertificateGenerationConnector.CertificateGenerationClientConnector(CERT_GEN_URL, CERT_GEN_USERNAME, CERT_GEN_PASSWORD);
        //        //certificateGenerationResponse response = connector.submitRequest(certRefNumber, formOID, rawHashValue, HASH_FUNCTION_OID);
        ...
        //        //    MsgStatus += "- Request CertGen Error " + response.statusCode + ": " + response.statusMessage + "\n";
        //        //    return false;
        //        //}

        //        //string rawECertificate = ((certificateGenerationResponseObject)response.responseData).certificateForm;
        ...
        //        //================================================================
        //        //byte[] filledPDF = new PdfManipulator().importXml(eCertificate, new FileStream(CANONICALIZATION_XML_PATH, FileMode.Open), true);
        //        System.IO.MemoryStream mstream = new System.IO.MemoryStream(bxml);
        //        byte[] filledPDF = new PdfManipulator().importXml(eCertificate, mstream, true);
        ...
        //            byte[] signedPDF = signWithWindowStore(filledPDF, SIG_IMAGE, Reason, Location, SignSNToken, iQRcode);
        //            if (signedPDF != null && signedPDF.Length > 0)
        //            {
        //                //File.WriteAllBytes(SIGNED_ECERTIFICATE_PATH, signedPDF);
        //                //File.WriteAllBytes(@"E:\\Workspace\\OCSB\\App\\OCSB Borwser Client V3.0.0_TEST\\bin\\x64\\Debug\\tmp_xml\\signedPDF.pdf", signedPDF);
        ...
        public Boolean inToSignPDFa(string strxml, string EmbedXML, string FormType, string Reference,string RequestNo, string SignaturePath, string SignSNToken)
        {
            ...
            if (xmlfromweb != "")
            {
                ...
                if (filledPDF != null && filledPDF.Length > 0)
                {
                    ...
                    // Digital Sign specify certificate 
                    //byte[] signedPDF = signWithKeyStore(filledPDF, KEYSTORE_PATH, KEYSTORE_PASSWORD, SIG_IMAGE, Reason, Location, iQRcode);
                    byte[] signedPDF = signWithWindowStore(PDFA3, SIG_IMAGE, Reason, Location, SignSNToken, iQRcode, FormType);
        ...
        public static byte[] signWithWindowStore(byte[] originalPDF, String imagePath, String sReason, String sLocation, String SNToken, String urlqrcode, String FrmType)
        {
            PdfManipulator pdfM = new PdfManipulator();
        ...
        //        this.signingCerts = this.GetCertificatesFromStore(validonly);
        //        foreach (X509Certificate2 cert in this.signingCerts)
        //        {
        ...
        //private void frmSignDS_Load(object sender, EventArgs e)
        //{
        ...
        public static string CheckLCToken(string SNToken)
        {
            PdfManipulator pdfM = new PdfManipulator();
            // ====================================== get key & sign ======================================
            X509Store store = new X509Store(StoreName.My, StoreLocation.CurrentUser);
        ...
        ////////
        //public byte[] signPdf(byte[] inputPdf, byte[] sigImg, string signatureField, string Reason, string Location, string streturn, byte[] urlqrcode)
        //{
        //    if (streturn == "true")
        //    {
        ...
        //        try
        //        {
        //            AcroFields.FieldPosition fq = form.GetFieldPositions("QRCode")[0];
        ...
        //            tsaClient = new TeDATimeSSLClient(TSAurl, cert);
